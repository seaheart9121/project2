...
def train_color_net(resume=False):
    ...
    dataset_dir = './color_dataset1' # Generated by augment_green.py
    ...
    # print("模型已保存到 color_runs/color_best.pth")
        ...
        # ✅ 路径：colornet/color_runs/color_last.pth（完全对应你屏幕的位置）
        checkpoint_path = "./color_runs/color_last.pth"
        torch.save(checkpoint, checkpoint_path)

        # 保存最佳模型（仅权重）
        # ✅ 路径：colornet/color_runs/color_best.pth
        torch.save(model.state_dict(), "./color_runs/color_best.pth")
        print("模型已保存到 colornet/color_runs/color_best.pth")
